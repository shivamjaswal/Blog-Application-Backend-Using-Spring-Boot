...
import com.codewithshivam.blog.exceptions.ResourceNotFoundException;
import com.codewithshivam.blog.payloads.PostDto;
import com.codewithshivam.blog.payloads.PostResponse;
import com.codewithshivam.blog.repositories.CategoryRepo;
import com.codewithshivam.blog.repositories.PostRepo;
import com.codewithshivam.blog.repositories.UserRepo;
import com.codewithshivam.blog.services.PostService;
...
public class PostServiceImpl implements PostService{
	...
	public PostDto updatePost(PostDto postDto, Integer postId) {
		...
		.orElseThrow(() -> new ResourceNotFoundException("Post", "postr id", postId));
	...
	public List<PostDto> getPostByCategory(Integer categoryId) {
		...
		Category cat = this.categoryRepo.findById(categoryId).orElseThrow(() -> new ResourceNotFoundException("User", "user id", categoryId));
